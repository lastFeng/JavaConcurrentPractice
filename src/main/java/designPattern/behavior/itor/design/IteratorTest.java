package designPattern.behavior.itor.design;

import designPattern.behavior.itor.design.group.Employee;
import designPattern.behavior.itor.design.group.GroupStructure;
import designPattern.behavior.itor.design.group.Link;
...
public class IteratorTest {
    ...
    public static void main(String[] args) {
        ...
        while (iterator.hasNext()) {
            ...
            logger.info("{0}，雇员 Id：{1} Name：{2}", employee.getDesc(), employee.getuId(), employee.getName());
        }
    }
}
