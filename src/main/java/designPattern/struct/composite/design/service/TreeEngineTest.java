package designPattern.struct.composite.design.service;
...
import designPattern.struct.composite.design.service.engine.IEngine;
import designPattern.struct.composite.design.service.engine.impl.TreeEngineHandle;
...
public class TreeEngineTest {
    ...
    public static void main(String[] args) {
        logger.info("决策树组合结构信息：{0}", JSON.toJSONString(treeRich));
        ...
        logger.info("测试结果：{0}", JSON.toJSONString(result));
    }
